 ...
 * @author xu222
 */
public class CompositeValidator implements BaseValidator {

    public static final String validatorName = "composite";

    public static final String PROP_EXPRESSION = "expression";

    public enum ValidatorProperty implements EnumProperty {

        EXPRESSION(PROP_EXPRESSION, String.class, null, false);
    ...
    public CompositeValidator(ValidationType.Validator validator, Errors errors, String fieldName, Term term) {
        List<Property> validatorProps = validator.getProperty();
        for (Property property : validatorProps) {
            String propName = property.getName();
            if (propName.equalsIgnoreCase(PROP_EXPRESSION)) {
    ...
    public Object validate(Object value, String fieldName, Errors errors) {
        // current we are not doing validation to composite terms
        return errors;
    }

...
CREATE VIEW "public"."view_pjtd" AS
...
CREATE VIEW "public"."view_sid" AS
SELECT DISTINCT 'U' || coalesce(u.id, 0) "sid", u.tenant_id "tenant_id"
FROM "public"."user" u
UNION
SELECT DISTINCT 'G' || coalesce(g.id, 0) "sid", g.tenant_id "tenant_id"
FROM "public"."group" g
;
...
DROP VIEW "public"."view_sid";
DROP VIEW "public"."view_pjtd";
